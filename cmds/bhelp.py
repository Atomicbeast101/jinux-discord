...
async def ex(dclient, private_channel, public_channel, mention, a, cmd_char):
    ...
    if len(a) == 2:
        ...
        if(cmd in HELP_CMD.keys()):
            ...
            msg = await dclient.send_message(public_channel, '{}, I sent you the specific help guide in a private message.'
                                       .format(mention))
        else:
            msg = await dclient.send_message(public_channel, 'I am unable to find the command you are looking for, {}! '
        ...
        msg = await dclient.send_message(public_channel, '{}, I sent you the help guide in a private message.'
                                   .format(mention))
    return msg
